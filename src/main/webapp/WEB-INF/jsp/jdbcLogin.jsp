...
<br>
<h2>JDBC Login Test</h2>
<c:if test="${jdbcMessage != null}">
    <div class="popup" data-popup="error">
        <div class="popup-inner">
            <h2>Jdbc Login Error !</h2>
            <br>
            <center><font color="red"><c:out value="${jdbcMessage}" /></font></center>
            <br>
...
<form id="loginBean" name="loginBean" action="jdbcLogin" method="post">
